...
public class PruebaAudioVisual {
    public static void main(String[] args) {
        ...
        ContenidoAudiovisual[] contenidos = new ContenidoAudiovisual[5]; // Cambiado a 5 para incluir 2 nuevas subclases
        ...
        Cortometraje cortometraje = new Cortometraje("La Historia de un Sueño", 15, "Drama", "Juan Pérez", 2022);
        contenidos[3] = cortometraje;

        // Crear un video de streaming
        VideoStreaming videoStreaming = new VideoStreaming("Cocinando con Estrellas", 30, "Culinaria", "Netflix", true);
        contenidos[4] = videoStreaming;
